...
const slides = [
  ...
  {
    id: '2',
    image: require('../images/goals.png'),
    title: 'Achieve Your Goals',
    subtitle: 'Optimize student performance and security by tracking attendance access.',
  },
  {
    id: '3',
    image: require('../images/value.png'),
    title: 'Increase Your Value',
    subtitle: 'Lets get the most out of technology today.',
  },
];
...
const Slide = ({item}) => {
  return (
    <View style={{alignItems: 'center'}}>
      <Image
        source={item?.image}
        style={{height: '76%', width, resizeMode: 'contain'}}
      />
      <View>
